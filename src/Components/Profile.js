...
function Profile() {
    ...
    useEffect(() => {
        const fetchAnimeList = async () => {
            try {
                const response = await axios.get('https://anime-list-web-d4706ee3e7f1.herokuapp.com/api/anime');
    ...
    const handleStatusChange = async (animeId, newStatus) => {
        try {
            await axios.put(`https://anime-list-web-d4706ee3e7f1.herokuapp.com/api/anime/${animeId}`, { status: newStatus });
    ...
    const handleDelete = async (animeId) => {
        try {
            await axios.delete(`https://anime-list-web-d4706ee3e7f1.herokuapp.com/api/anime/${animeId}`);
